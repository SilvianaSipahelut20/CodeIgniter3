...
\label{Gambar 7}
\end{figure}
Seetelah membuat kode program seperti gambar diatas simpan \textit{file} diatas dengan nama yang bebas sesuai keinginan masing-masing (misalnya:belajarview.php) dan tempatkan pada direktori berikut :
